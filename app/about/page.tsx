  ...
  return (
    ...
    >
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Reveal>
          <GlassCard className="p-8 md:p-12 lg:col-span-2 lg:p-14 xl:p-16">
            ...
            <div className="mx-auto mt-12 max-w-6xl grid gap-5 md:grid-cols-2 xl:grid-cols-4">
      ...
      <Reveal>
        <GlassCard className="mt-6 p-8 text-center md:p-10 lg:p-12">
